...
/*    const heroes = of(HEROES);
      ...
      return heroes;  MUUTETTU OSASSA 6. */  
  }
/*    getHeroes(): Hero[] {
      return HEROES;
    } MUUTETTU OSASSA 4 */
...
// For now (OSA 5), assume that a hero with the specified `id` always exists.
// Error handling will be added in the next step of the tutorial.
/*     const hero = HEROES.find(h => h.id === id)!;
  this.messageService.add(`HeroService: fetched hero id=${id}`);
  return of(hero);  MUUTETTU OSASSA 6.  */
  }
...
/** Log a HeroService message with the MessageService  METODI VAI KONSTRUKTORIIN?*/
